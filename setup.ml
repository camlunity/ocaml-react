...
(* OASIS_START *)
(* DO NOT EDIT (digest: a2d689d153ce79fe2ebdd7103c50aa3a) *)
(*
...
# 21 "/home/typhon/data/kamlo/oasis-0.2.1~alpha1/src/plugins/custom/CustomPlugin.ml"
...
let setup_t =
  {
     ...
     doc = [("react-api", OCamlbuildDocPlugin.doc_build "src")];
     ...
     clean_doc = [("react-api", OCamlbuildDocPlugin.doc_clean "src")];
     distclean = [];
     distclean_test =
       [
          ("main",
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Daniel C. B\195\188nzli <daniel.buenzli@erratique.ch>"];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "API reference for react";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               SrcRepo
                 ({
                     ...
                     },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "git://github.com/camlunity/ocaml-react.git";
                      src_repo_browser =
                        Some "https://github.com/camlunity/ocaml-react";
